            ...
            while(scanner.hasNextLine()) {
                ...
                for (int i = 0; i < turns.length; i++) {
                    ...
                    for (int j = 0; j < entries.length; j++) {
                        ...
                        switch (ballcounts[1]) {
                            case "red":     possible = (num > numRed) ? false : possible; break;
                            case "green":   possible = (num > numGreen) ? false : possible; break;
                            case "blue":    possible = (num > numBlue) ? false : possible; break;
                            default:        break;
                        }
